...
SELECT customers.company_name, CONCAT(employees.first_name, ' ', employees.last_name) as employee FROM customers
...
SELECT product_name, units_in_stock, suppliers.company_name, suppliers.phone FROM products
